 ...
 */
public class AllSlotsData {

    String slot2,slot3,slot4,slot5,slot6,slot7;

    public AllSlotsData(String slot2, String slot3, String slot4, String slot5, String slot6, String slot7) {
        this.slot2 = slot2;
        this.slot3 = slot3;
        this.slot4 = slot4;
        this.slot5 = slot5;
