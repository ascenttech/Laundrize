 ...
 */
public class RegisterUserViaSocialAsyncTask extends AsyncTask<String,Void,Boolean> {

    Context context;
    RegisterUserViaSocialCallback callback;

    public interface RegisterUserViaSocialCallback{

        public void onStart(boolean status);
        public void onResult(boolean result);
    }

    public RegisterUserViaSocialAsyncTask(Context context, RegisterUserViaSocialCallback callback) {
